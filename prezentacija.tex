...
\subsubsection{Primena Lue kao skript jezika}
\begin{frame}
...
\begin{frame} 
\frametitle{Programiranje u Lui}

\begin{itemize}
\item instalacija - neophodan ili dovoljan uslov
\item \textcolor{green}{Unix} - Mac, Linux
\item \textcolor{red}{Windows}
\item specifično kastovanje
\item nil, bool, brojevi, string, korisnički podaci, funkcije, niti i table
...
\begin{itemize}
\item Nastala za lokalne potrebe, danas ima primenu u svetu
\item Široka oblast primene
\item Skraćeni zapis
\item Portabilnost
\item Skupljač otpadaka
\item Objektno-orijentisana, funkcionalna i proceduralna paradigma
\item Jezik proširenja
\end{itemize}
...
and (Constraint) Logic Programming, page 5–13, 2009.}, on-line at: https://www.inf.puc-rio.br/%7Eroberto/docs/ry09-03.pdf}
