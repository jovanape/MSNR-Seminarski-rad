...
\begin{lstlisting}[caption={Dodela vrednosti tipa \textit{function} promenljivoj foo},frame=single, label=fun1]
...
\begin{lstlisting}[caption={Sortiranje vrednosti tabele},frame=single, label=fun3]
